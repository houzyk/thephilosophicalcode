...
```
  ...
  We can now check whether 15 and 14 are even- `even(14)` prints `14 is even` and `even(15)` prints `15 is odd`. Notice that we don't code repeating conditionals anymore. We don't repeat ourselves!
