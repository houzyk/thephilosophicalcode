...
However, our claim does have implications on specialised compression algorithms. In particular, they are subject to a no-free-lunch limit - even if these algorithms may be perfect within their specialised subset, they cannot be perfect in compressing anything beyond that subset. Moreover, it's impossible to simply merge multiple potentially perfect specialised algorithms to create a perfect “master compression algorithm” across all data types.
