...
description: "The MDN reference on regular expressions states that \"JavaScript regular expressions are in fact not regular, due to the existence of backreferences\". This reflects a subtle distinction between regular expressions in theory and their implementation in JavaScript. In this article, we'll clarify this distinction by exploring the theory behind regular expressions and how backreferences make JavaScript's regular expressions irregular."
...
![(Ir)regular Expressions](/images/irregular-javascript-expressions/cover.webp)
